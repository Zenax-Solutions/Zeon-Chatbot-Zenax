...
return [
    ...
    */
    ...
    'products' => [
        'basic' => 'prod_S5vak66RgnmIae',       // Replace with actual Stripe product ID
        'standard' => 'prod_S5vbjP0OICSy6Q', // Replace with actual Stripe product ID
        'premium' => 'prod_S5vbBIscrTI7Yy',   // Replace with actual Stripe product ID
    ],
